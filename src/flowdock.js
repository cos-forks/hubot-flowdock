...
(function() {
  ...
  Flowdock = (function(superClass) {
    ...
    Flowdock.prototype.flowFromParams = function(params) {
      var flow, i, len, ref2;
      ref2 = this.flows;
      for (i = 0, len = ref2.length; i < len; i++) {
        flow = ref2[i];
        if (params.room === flow.id) {
          return flow;
        }
      }
    };
    ...
    Flowdock.prototype.myId = function(id) {
      return String(id) === String(this.bot.userId);
    };
    ...
    Flowdock.prototype.connect = function() {
      ...
      return this.stream.on('message', (function(_this) {
        return function(message) {
          ...
          regex = new RegExp("^@" + _this.bot.userName + "(,|\\b)", "i");
          hubotMsg = msg.replace(regex, botPrefix);
          if (!message.flow && !hubotMsg.match(new RegExp("^" + _this.robot.name, "i"))) {
